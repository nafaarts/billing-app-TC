...
@section('body')
    <div class="p-6 bg-white rounded-md shadow-md">
        <h2 class="text-lg text-gray-700 font-semibold capitalize">Edit user</h2>
        <hr class="my-3">
            ...
            <div class="flex">
                <div class="md:w-1/3 w-full">
                    <div class="mt-2 h-full flex items-center justify-center">
                        ...
                        <style>
                            .input-file {
                                background-image: url("{{ asset('img/users/' . $data->image) }}");
                ...
                <div class="md:w-2/3">
                    ...
                    <div class="mt-2">
                        <label for="level" class="text-xs mb-1">Level Account</label>
